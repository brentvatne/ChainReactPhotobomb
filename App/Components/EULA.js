    ...
    <View style={styles.container}>
      <ScrollView style={styles.textWrapper}>
        ...
        <Text style={styles.text}>
          ...
          App Store. By installing the Chain React Photobomb App, you agree to
          be bound by this Agreement and understand that there is no tolerance
          for objectionable content. If you do not agree with the terms and
          ...
          the “Flag this photo” feature found when viewing an image.
          {'\n\n'}
          1. Parties
          {'\n'}
          ...
          information from and about your device. Chain React Photobomb may use
          ...
          App for your personal, non-commercial purposes. You may only use the
          Chain React Photobomb App on devices that you own or control and as
          ...
          of the Chain React Photobomb App does not violate any applicable law
          or regulation. Your access to the Chain React Photobomb App may be
          ...
          are a parent or legal guardian and you provide your consent to your
          child’s use of the Chain React Photobomb App, you agree to be bound by
          this Agreement in respect to your child’s use of the Chain React
          Photobomb App.
          {'\n\n'}
          5. Objectionable Content Policy
          {'\n'}
          Content may not be submitted to Chain React Photobomb, who will
          moderate all content and ultimately decide to remove a submission to
          ...
          any warranty exists under law that cannot be disclaimed, Chain React
          ...
          it but not to the extent that any maintenance or support is required
          by applicable law, Chain React Photobomb shall be obligated to furnish
          any such maintenance or support.
          {'\n\n'}
          8. Product Claims
          {'\n'}
          Chain React Photobomb is responsible for addressing any claims by you
          relating to the Chain React Photobomb App or use of it, including, but
          not limited to: (i) any product liability claim; (ii) any claim that
          the Chain React Photobomb App fails to conform to any applicable legal
          or regulatory requirement; and (iii) any claim arising under consumer
          ...
          you with respect to any third party claim arising out or relating to
          the Chain React Photobomb App. To the extent Chain React Photobomb is
          required to provide indemnification by applicable law, Chain React
          Photobomb, shall be solely responsible for the investigation, defense,
          settlement and discharge of any claim that the Chain React Photobomb
          App or your use of it infringes any third party intellectual property
          right.
        </Text>
      </ScrollView>
